...
(function () {
  ...
  function render() {
    ...
    document.getElementById('view-about').innerHTML = '<article class="wrap"><div class="prose">' +
      ...
      '<p>Each transient has its own page with the TNS record, links to other archives, the lightcurve, sky images, broker classifications with metaDEBASS confidences, and any public TNS spectra. Search from anywhere with <span class="kbd">⌘K</span> or <span class="kbd">/</span>, and step through the current list with ← and →.</p>' +
      '<p><a href="#/classifiers">Classifiers</a> shows how often each broker classifier was right on the spectroscopically typed transients. <a href="#/data">Data</a> has the catalogue and every public photometry point as plain files, a Python example, and how to cite the site and its sources.</p>' +
      ...
      '<li><strong>Classifiers</strong>: Fink SuperNNova (Möller &amp; de Boissière 2020, MNRAS 491, 4277), CATS (Fraga et al. 2024, A&amp;A 692, A208) and EarlySNIa (Leoni et al. 2022, A&amp;A 663, A13); ' +
        ...
        '<a href="https://github.com/trivialTZ/rubin_hackathon" target="_blank" rel="noopener">metaDEBASS</a> is a research meta-layer over these broker outputs and early lightcurves: it reports calibrated confidences for follow-up ranking and how far to trust each broker, not a classification.</li>' +
